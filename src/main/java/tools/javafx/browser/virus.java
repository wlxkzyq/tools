...
public class virus extends Application{
	...
	public void initStage(Stage primaryStage){
		//设置图标
		primaryStage.getIcons().add(new Image(virus.class.getResourceAsStream("image/icon6.png")));
		//设置透明度
	...
	class Browser extends Region{
	    ...
	    public Browser() {
	    	...
	    	String url=virus.class.getResource("html/shutdown.html").toExternalForm();
	    	//webEngine.load(url);
